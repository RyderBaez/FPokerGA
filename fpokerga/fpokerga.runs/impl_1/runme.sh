...
HD_PWD='C:/Users/ericsc/FPokerGA/fpokerga/fpokerga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log poker_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source poker_top.tcl -notrace
