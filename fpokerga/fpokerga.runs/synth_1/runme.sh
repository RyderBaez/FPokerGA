...
HD_PWD='C:/Users/ericsc/FPokerGA/fpokerga/fpokerga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log poker_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source poker_top.tcl
